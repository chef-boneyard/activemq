...
property :version, String, required: true, default: '5.12.0'
property :home, String, required: true, default: '/opt'
...
action_class do
  ...
  def fetch_checksum
    uri = URI.join(new_resource.sha1_base_path, "#{new_resource.version}/apache-activemq-#{new_resource.version}-bin.tar.gz.sha1")
